...
public class APILogParserTest {
    ...
    public void setUp() throws Exception {
        line = "nginx: dal-front2:200:57:0.000:-:/notifications/show/12asda1213,-1_234213.json?par1=val1:Picsart/3.0:andy-4d50258d-7b5a-44fc-971a-eb9a203fc524:TR:tr:android:141 - GET 200 57 [23/May/2015:06:39:48 +0000]";
    }
    ...
    public void testParseEvent() throws Exception {
       ...
       // assertEquals("/notifications/show/me.json?par1=val1", uniformAPILogEntry.getRequestString());
        assertEquals("/notifications/show.json", uniformAPILogEntry.getRequestURL().replaceAll("/[0-9a-zA-Z,^*%_-]+.json", ""));
